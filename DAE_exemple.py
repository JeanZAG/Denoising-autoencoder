...
### script implemented to give an exemple of the use of Denoising-autoencoder algorithm
###script originally inteded to be integrated in SyncPy library
###https://github.com/syncpy/SyncPy/tree/master/examples
###sould appear soon in the link above

###module author : Jean Zagdoun


#script usefull for SyncPy 
#import sys
